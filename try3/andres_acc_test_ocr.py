...
parameters = param()
files = os.listdir("../../data/fish/test-img-type2/")
samples = len(files)
img_path = "../../data/fish/test-img-type2/"
lbl_path = "../../data/fish/test-lbl-type2/"
img_queue = []
lbl_queue = []
for file in files:
...
with tf.Session() as sess:
	...
	print
	print "auc:", auc
	print "accuracy:", round(acc_total*100.0/samples,2),"total good int:",int(acc_total), "of", int(total_s)
