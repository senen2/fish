...
features = scipy.io.loadmat("resp_50_cost_conv7_chan_16 (copy 2)")
sub_file = "submission_14_stg1.csv"
parameters = param()
...
h_pool_last_flat = tf.reshape(h_pool7, [-1, last_img_size * last_img_size  * cv_all_channels])
